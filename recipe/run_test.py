...
See: https://github.com/conda-forge/jupyterlab_widgets-feedstock/issues/47
"""
...
JS_NAME = os.environ.get("JS_NAME", "@jupyter-widgets/jupyterlab-manager")
...
if __name__ == "__main__":
    rcs = [
        check_bad_paths(),
        do(["jupyter", "labextension", "list", "--debug"], rf"{re.escape(JS_NAME)}.*OK"),
    ]
    sys.exit(max(rcs))
